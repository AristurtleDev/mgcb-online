...
public class H264PageModel : PageModel
{
    public class Input
    {

        [DisplayName("Mp4 File")]
    ...
    public H264PageModel(IWebHostEnvironment environment)
    {
    ...
    public async Task<ActionResult> OnPostAsync()
    {
        ...
        mgcbInfo.ArgumentList.Add($"/importer:H264Importer");
        mgcbInfo.ArgumentList.Add($"/processor:VideoProcessor");
