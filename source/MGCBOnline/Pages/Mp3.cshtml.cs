...
public class Mp3PageModel : PageModel
{
    public class Input
    {

        [DisplayName("Mp3 File")]
    ...
    public Mp3PageModel(IWebHostEnvironment environment)
    {
    ...
    public async Task<ActionResult> OnPostAsync()
    {
        ...
        mgcbInfo.ArgumentList.Add($"/importer:Mp3Importer");
        mgcbInfo.ArgumentList.Add($"/processor:SongProcessor");
