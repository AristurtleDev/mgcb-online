...
public class OggPageModel : PageModel
{
    public class Input
    {

        [DisplayName("Ogg File")]
    ...
    public OggPageModel(IWebHostEnvironment environment)
    {
    ...
    public async Task<ActionResult> OnPostAsync()
    {
        ...
        mgcbInfo.ArgumentList.Add($"/importer:OggImporter");
