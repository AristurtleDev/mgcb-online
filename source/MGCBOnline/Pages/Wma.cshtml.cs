...
public class WmaPageModel : PageModel
{
    public class Input
    {

        [DisplayName("Wma File")]
    ...
    public WmaPageModel(IWebHostEnvironment environment)
    {
    ...
    public async Task<ActionResult> OnPostAsync()
    {
        ...
        mgcbInfo.ArgumentList.Add($"/importer:WmaImporter");
        mgcbInfo.ArgumentList.Add($"/processor:SoundEffectProcessor");
        mgcbInfo.ArgumentList.Add($"/processorParam:{nameof(Input.Quality)}={Form.Quality}");
