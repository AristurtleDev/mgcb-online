...
public class WmvPageModel : PageModel
{
    public class Input
    {

        [DisplayName("Wmv File")]
    ...
    public WmvPageModel(IWebHostEnvironment environment)
    {
    ...
    public async Task<ActionResult> OnPostAsync()
    {
        ...
        mgcbInfo.ArgumentList.Add($"/importer:WmvImporter");
