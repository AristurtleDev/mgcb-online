...
public class XmlPageModel : PageModel
{
    ...
    public XmlPageModel(IWebHostEnvironment environment)
    {
    ...
    public async Task<ActionResult> OnPostAsync()
    {
        ...
        mgcbInfo.ArgumentList.Add($"/importer:XmlImporter");
        mgcbInfo.ArgumentList.Add($"/processor:PassThroughProcessor");
